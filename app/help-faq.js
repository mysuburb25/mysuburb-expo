...
const FAQS = [
  ...
  { q: 'How do I change my suburb?', a: 'Go to your Profile, open the Suburbs tab, and tap the edit icon. You can search for any suburb in Australia.' },
  ...
  { q: 'Can other users see my email address?', a: 'No. Your email address is kept private and is never shown to other users, even on your profile.' },
  ...
  { q: 'Can I add photos or videos to a post?', a: 'Yes, when creating a post you can attach up to 8 photos and videos in total, from your camera or your library.' },
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.pageHeader}>
        <Text style={styles.pageTitle} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.8}>Help and FAQ</Text>
      </View>
