  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.body}>If you encounter any content that concerns child safety, please report it immediately using the Report feature on the relevant post, comment, or user, or contact us at support@mysuburb.app.</Text>
        ...
        <Text style={styles.body}>If you believe a moderation decision was made in error, you can appeal by contacting support@mysuburb.app with details of the decision and why you believe it should be reviewed.</Text>

        <Text style={styles.heading}>Contact Us</Text>
        <Text style={styles.body}>To report a serious issue or appeal a moderation decision, contact us at support@mysuburb.app</Text>
